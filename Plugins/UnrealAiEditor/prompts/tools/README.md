...
- **Canonical catalog (this plugin):** Primary [`../../Resources/tools.main.json`](../../Resources/tools.main.json) (`meta` + main roster); merged with [`../../Resources/tools.blueprint.json`](../../Resources/tools.blueprint.json) per **`meta.tool_catalog_fragments`** — full parameters, `modes`, `permission`, `status`, `failure_modes` after merge.
