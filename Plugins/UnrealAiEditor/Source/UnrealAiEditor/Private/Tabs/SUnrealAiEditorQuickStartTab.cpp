					...
					[
						SNew(STextBlock)
							...
							.Text(LOCTEXT(
								...
								"2) Add an API key in API Keys & Models or AI Settings JSON — otherwise the LLM runs in stub mode\n"
								"3) Use Attach for Content Browser selection; @ mentions resolve assets\n"
