...
| `UnrealAiEditor.Tools.BlueprintApplyIrContract` | Catalog-removed Blueprint tools return `tool_deprecated` + `suggested_correct_call`; includes T3D/IR/format_selection/open_graph/composite ids. |
