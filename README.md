...
- Primary map for quick scanning: [`architecture.svg`](architecture.svg)
- Full rendered gallery: [`docs/architecture-maps/`](docs/architecture-maps)
- Source of truth: [`docs/architecture-maps/architecture.dsl`](docs/architecture-maps/architecture.dsl)

<!-- ARCHITECTURE_MAPS_START -->
_This section is auto-generated by `.github/workflows/architecture-maps.yml`._
