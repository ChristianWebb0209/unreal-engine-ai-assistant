...
| [`tooling/`](tooling/) | Harness iteration, tool catalog narrative, **[tool dispatch inventory](tooling/tool-dispatch-inventory.md)** (compat aliases, console policy), tools expansion, audits, agent requirements, Fab tool plan. |
