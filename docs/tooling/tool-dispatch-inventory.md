...
| `blueprint_graph_get_graph_summary` | Normalized to `blueprint_get_graph_summary` (symmetric-name mistake vs `blueprint_graph_introspect` / `blueprint_graph_patch`). |
